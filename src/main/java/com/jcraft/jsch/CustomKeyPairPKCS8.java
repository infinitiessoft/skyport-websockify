...
public class CustomKeyPairPKCS8 extends CustomKeyPair {

	private static final byte[] rsaEncryption = { (byte) 0x2a, (byte) 0x86, (byte) 0x48, (byte) 0x86, (byte) 0xf7,
			(byte) 0x0d, (byte) 0x01, (byte) 0x01, (byte) 0x01 };

	private static final byte[] dsaEncryption = { (byte) 0x2a, (byte) 0x86, (byte) 0x48, (byte) 0xce, (byte) 0x38,
			(byte) 0x04, (byte) 0x1 };

	private static final byte[] pbes2 = { (byte) 0x2a, (byte) 0x86, (byte) 0x48, (byte) 0x86, (byte) 0xf7, (byte) 0x0d,
			(byte) 0x01, (byte) 0x05, (byte) 0x0d };

	// private static final byte[] pbkdf2 = { (byte) 0x2a, (byte) 0x86, (byte)
	// 0x48, (byte) 0x86, (byte) 0xf7, (byte) 0x0d,
	// (byte) 0x01, (byte) 0x05, (byte) 0x0c };

	private static final byte[] aes128cbc = { (byte) 0x60, (byte) 0x86, (byte) 0x48, (byte) 0x01, (byte) 0x65, (byte) 0x03,
			(byte) 0x04, (byte) 0x01, (byte) 0x02 };

	private static final byte[] aes192cbc = { (byte) 0x60, (byte) 0x86, (byte) 0x48, (byte) 0x01, (byte) 0x65, (byte) 0x03,
			(byte) 0x04, (byte) 0x01, (byte) 0x16 };

	private static final byte[] aes256cbc = { (byte) 0x60, (byte) 0x86, (byte) 0x48, (byte) 0x01, (byte) 0x65, (byte) 0x03,
			(byte) 0x04, (byte) 0x01, (byte) 0x2a };

	private static final byte[] pbeWithMD5AndDESCBC = { (byte) 0x2a, (byte) 0x86, (byte) 0x48, (byte) 0x86, (byte) 0xf7,
			(byte) 0x0d, (byte) 0x01, (byte) 0x05, (byte) 0x03 };

	private CustomKeyPair kpair = null;


	public CustomKeyPairPKCS8() {
		super();
	}
	...
	boolean parse(byte[] plain) {
		...
		try {
			...
			if (Util.array_equals(privateKeyAlgorithmID, rsaEncryption)) {
				...
				CustomKeyPairDSA _key = new CustomKeyPairDSA(P_array, Q_array, G_array, pub_array, prv_array);
				plain = _key.getPrivateKey();

				_kpair = new CustomKeyPairDSA();
				_kpair.copy(this);
	...
	public boolean decrypt(byte[] _passphrase) {
		...
		try {
			...
			byte[] key = null;
			try {
				Class<?> c = Class.forName(Config.getConfig("pbkdf"));
	...
	Cipher getCipher(byte[] id) {
		...
		try {
			...
			Class<?> c = Class.forName(Config.getConfig(name));

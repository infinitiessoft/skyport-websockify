...
public class CustomKeyPairRSA extends CustomKeyPair {
	...
	public CustomKeyPairRSA() {
		this(null, null, null);
	}

	public CustomKeyPairRSA(byte[] n_array, byte[] pub_array, byte[] prv_array) {
		super();
	...
	void generate(int key_size) throws JSchException {
		...
		try {
			Class<?> c = Class.forName(Config.getConfig("keypairgen.rsa"));
	...
	public byte[] getSignature(byte[] data) {
		try {
			Class<?> c = Class.forName(Config.getConfig("signature.rsa"));
	...
	static CustomKeyPair fromSSHAgent(Buffer buf) throws JSchException {
		...
		CustomKeyPairRSA kpair = new CustomKeyPairRSA(n_array, pub_array, prv_array);

...
//
//import com.jcraft.jsch.Channel.PassiveInputStream;
//
//public class CustomChannelForwardedTCPIP extends CustomChannel {
//
...
//
//
//	public CustomChannelForwardedTCPIP() {
//		super();
...
//		} catch (Exception e) {
//			sendOpenFailure(SSH_OPEN_ADMINISTRATIVELY_PROHIBITED, channel);
//			close = true;
//			disconnect(channel);
//			return;
//		}
...
//				i = io.in.read(buf.getBuffer(), 14, buf.getBuffer().length - 14 - Session.buffer_margin);
//				if (i <= 0) {
//					eof(channel);
//					break;
//				}
...
//					if (close)
//						break;
//					_session.write(packet, this, i, channel);
//				}
//			}
//		} catch (Exception e) {
...
//	}
//
//	static void addPort(Session session, String _address_to_bind, int port, int allocated_port, String target, int lport,
...
//	}
//
//	static void addPort(Session session, String _address_to_bind, int port, int allocated_port, String daemon, Object[] arg)
...
//	}
//
//	static void delPort(CustomChannelForwardedTCPIP c) {
//		Session _session = null;
//		try {
